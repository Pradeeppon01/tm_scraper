...
//if(window.location.pathname==="/machine/editMachine"){
//	console.log("Has edit machine")
//	const body_element=document.querySelector('body')[0]
//	console.log("Body element is : ",body_element)
//	window.scrollTo(0,0)
//	html2canvas(body_element.then(function(canvas){
//		console.log(canvas.toDataURL("image/jpeg",0.9));
//	}))
//}else{
//	console.log("No edit machine")
//}
